...
class SCashKerasPage extends StatefulWidget {
  const SCashKerasPage({Key? key}) : super(key: key);

  @override
  _SCashKerasPageState createState() => _SCashKerasPageState();
}

class _SCashKerasPageState extends State<SCashKerasPage> {
  var isLoading = false;
  var isData = false;
