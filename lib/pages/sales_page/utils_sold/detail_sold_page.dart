...
class SDetailSoldPage extends StatefulWidget {
  final Lead model;
  SDetailSoldPage(this.model);
  @override
  _SDetailSoldPageState createState() => _SDetailSoldPageState();
}

class _SDetailSoldPageState extends State<SDetailSoldPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
