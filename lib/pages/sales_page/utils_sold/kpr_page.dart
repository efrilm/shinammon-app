...
class SKprPage extends StatefulWidget {
  const SKprPage({Key? key}) : super(key: key);

  @override
  _SKprPageState createState() => _SKprPageState();
}

class _SKprPageState extends State<SKprPage> {
  var isLoading = false;
  var isData = false;
