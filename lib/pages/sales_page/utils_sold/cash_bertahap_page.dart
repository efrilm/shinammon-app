...
import 'package:shinnamon/pages/sales_page/utils_sold/detail_sold_page.dart';
...
class SCashBertahapPage extends StatefulWidget {
  const SCashBertahapPage({Key? key}) : super(key: key);

  @override
  _SCashBertahapPageState createState() => _SCashBertahapPageState();
}

class _SCashBertahapPageState extends State<SCashBertahapPage> {
  var isLoading = false;
  var isData = false;
  var paymentMethod = 'Cash Bertahap';
  List<Lead> list = [];
