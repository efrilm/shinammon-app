...
import 'package:shinnamon/pages/sales_page/utils_visit/detail_will_visit_page.dart';
...
class SWillVisit extends StatefulWidget {
  const SWillVisit({Key? key}) : super(key: key);

  @override
  _SWillVisitState createState() => _SWillVisitState();
}

class _SWillVisitState extends State<SWillVisit> {
  var isLoading = false;
  var isData = false;
  String status = '1';
  List<Visit> list = [];
