...
import 'package:shinnamon/pages/sales_page/utils_visit/detail_already_visit_page.dart';
...
class SAlreadyVisit extends StatefulWidget {
  const SAlreadyVisit({Key? key}) : super(key: key);

  @override
  _SAlreadyVisitState createState() => _SAlreadyVisitState();
}

class _SAlreadyVisitState extends State<SAlreadyVisit> {
  var isLoading = false;
  var isData = false;
  String status = '2';
  List<Visit> list = [];
