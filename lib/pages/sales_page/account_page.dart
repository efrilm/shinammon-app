...
class SAccountPage extends StatefulWidget {
  ...
  @override
  _SAccountPageState createState() => _SAccountPageState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            SettingCard(
              ...
              onTap: () {
                Navigator.pushNamed(context, '/s-kpr');
              },
            ),
            SettingCard(
              ...
              title: "Cash Keras",
              onTap: () {
                Navigator.pushNamed(context, '/s-cash-keras');
              },
            ),
            SettingCard(
              ...
              title: "Cash Bertahap",
              onTap: () {
                Navigator.pushNamed(context, '/s-cash-bertahap');
              },
            ),
          ],
        ),
