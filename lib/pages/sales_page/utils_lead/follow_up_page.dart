...
import 'package:shinnamon/pages/sales_page/utils_lead/detail_follow_up_page.dart';
...
class SFollowUpPage extends StatefulWidget {
  const SFollowUpPage({Key? key}) : super(key: key);

  @override
  _SFollowUpPageState createState() => _SFollowUpPageState();
}

class _SFollowUpPageState extends State<SFollowUpPage> {
  var isLoading = false;
  var isData = false;
  String status = '2';
  List<Lead> list = [];
