...
import 'package:shinnamon/pages/sales_page/actions/add_booking_page.dart';
...
class SDetailReservasiPage extends StatefulWidget {
  final Lead model;
  SDetailReservasiPage(this.model);
  @override
  _SDetailReservasiPageState createState() => _SDetailReservasiPageState();
}

class _SDetailReservasiPageState extends State<SDetailReservasiPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
            ...
            CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            AddBookingPage(widget.model.leadId, widget.model.homeId!)));
              },
              text: "Booking",
            ),
          ],
