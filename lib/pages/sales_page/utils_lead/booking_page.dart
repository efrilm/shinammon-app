...
import 'package:shinnamon/pages/sales_page/utils_lead/detail_booking_page.dart';
...
class SBookingPage extends StatefulWidget {
  const SBookingPage({Key? key}) : super(key: key);

  @override
  _SBookingPageState createState() => _SBookingPageState();
}

class _SBookingPageState extends State<SBookingPage> {
  var isLoading = false;
  var isData = false;
  String status = '5';
  List<Lead> list = [];
