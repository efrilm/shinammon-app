...
import 'package:shinnamon/pages/sales_page/utils_lead/detail_reservasi_page.dart';
...
class SReservasiPage extends StatefulWidget {
  const SReservasiPage({Key? key}) : super(key: key);

  @override
  _SReservasiPageState createState() => _SReservasiPageState();
}

class _SReservasiPageState extends State<SReservasiPage> {
  var isLoading = false;
  var isData = false;
  String status = '4';
  List<Lead> list = [];
