...
class StockAvailablePage extends StatefulWidget {
  const StockAvailablePage({Key? key}) : super(key: key);

  @override
  _StockAvailablePageState createState() => _StockAvailablePageState();
}

class _StockAvailablePageState extends State<StockAvailablePage> {
