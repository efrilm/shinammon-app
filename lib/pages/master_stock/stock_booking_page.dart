...
class StockBookingPage extends StatefulWidget {
  const StockBookingPage({Key? key}) : super(key: key);

  @override
  _StockBookingPageState createState() => _StockBookingPageState();
}

class _StockBookingPageState extends State<StockBookingPage> {
