...
import 'package:shinnamon/pages/markom/utils_lead/detail_reservation_page.dart';
...
class MReservationPage extends StatefulWidget {
  const MReservationPage({Key? key}) : super(key: key);
  @override
  _MReservationPageState createState() => _MReservationPageState();
}

class _MReservationPageState extends State<MReservationPage> {
  var isLoading = false;
  var isData = false;
  String status = '4';
  List<Lead> list = [];
