...
class MDetailBookingPage extends StatefulWidget {
  final Lead model;
  MDetailBookingPage(this.model);
  @override
  _MDetailBookingPageState createState() => _MDetailBookingPageState();
}

class _MDetailBookingPageState extends State<MDetailBookingPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
