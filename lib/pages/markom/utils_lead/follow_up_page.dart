...
import 'package:shinnamon/pages/markom/utils_lead/detail_follow_up_page.dart';
...
class MFollowUpPage extends StatefulWidget {
  const MFollowUpPage({Key? key}) : super(key: key);

  @override
  _MFollowUpPageState createState() => _MFollowUpPageState();
}

class _MFollowUpPageState extends State<MFollowUpPage> {
  var isLoading = false;
  var isData = false;
  String status = '2';
  List<Lead> list = [];
