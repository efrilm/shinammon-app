...
class MCashBertahapPage extends StatefulWidget {
  const MCashBertahapPage({Key? key}) : super(key: key);

  @override
  _MCashBertahapPageState createState() => _MCashBertahapPageState();
}

class _MCashBertahapPageState extends State<MCashBertahapPage> {
  var isLoading = false;
  var isData = false;
