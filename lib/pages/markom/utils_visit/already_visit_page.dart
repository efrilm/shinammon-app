...
import 'package:shinnamon/pages/markom/utils_visit/detail_already_visit_page.dart';
...
class MAlreadyVisitPage extends StatefulWidget {
  const MAlreadyVisitPage({Key? key}) : super(key: key);

  @override
  _MAlreadyVisitPageState createState() => _MAlreadyVisitPageState();
}

class _MAlreadyVisitPageState extends State<MAlreadyVisitPage> {
  var isLoading = false;
  var isData = false;
  String status = '2';
  List<Visit> list = [];
