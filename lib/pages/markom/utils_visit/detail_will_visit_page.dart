...
class MDetailWillVisitPage extends StatefulWidget {
  final Visit model;
  MDetailWillVisitPage(this.model);
  @override
  _MDetailWillVisitPageState createState() => _MDetailWillVisitPageState();
}

class _MDetailWillVisitPageState extends State<MDetailWillVisitPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
