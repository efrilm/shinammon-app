...
import 'package:shinnamon/pages/markom/utils_visit/detail_will_visit_page.dart';
...
class MWillVisitPage extends StatefulWidget {
  const MWillVisitPage({Key? key}) : super(key: key);

  @override
  _MWillVisitPageState createState() => _MWillVisitPageState();
}

class _MWillVisitPageState extends State<MWillVisitPage> {
  var isLoading = false;
  var isData = false;
  String status = '1';
  List<Visit> list = [];
