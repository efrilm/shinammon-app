...
class MDetailAlreadyVisitPage extends StatefulWidget {
  final Visit model;
  MDetailAlreadyVisitPage(this.model);
  @override
  _MDetailAlreadyVisitPageState createState() =>
      _MDetailAlreadyVisitPageState();
}

class _MDetailAlreadyVisitPageState extends State<MDetailAlreadyVisitPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
