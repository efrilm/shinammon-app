...
class ODetailReservationPage extends StatefulWidget {
  final Lead model;

  ODetailReservationPage(this.model);
  @override
  _ODetailReservationPageState createState() => _ODetailReservationPageState();
}

class _ODetailReservationPageState extends State<ODetailReservationPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
