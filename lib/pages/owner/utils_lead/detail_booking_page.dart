...
class ODetailBookingPage extends StatefulWidget {
  final Lead model;
  ODetailBookingPage(this.model);
  @override
  _ODetailBookingPageState createState() => _ODetailBookingPageState();
}

class _ODetailBookingPageState extends State<ODetailBookingPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
