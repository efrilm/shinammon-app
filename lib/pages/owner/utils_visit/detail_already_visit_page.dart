...
class ODetailAlreadyVisitPage extends StatefulWidget {
  final Visit model;
  ODetailAlreadyVisitPage(this.model);
  @override
  _ODetailAlreadyVisitPageState createState() =>
      _ODetailAlreadyVisitPageState();
}

class _ODetailAlreadyVisitPageState extends State<ODetailAlreadyVisitPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
