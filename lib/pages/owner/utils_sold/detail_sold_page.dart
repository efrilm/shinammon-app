...
class ODetailSoldPage extends StatefulWidget {
  final Lead model;
  ODetailSoldPage(this.model);
  @override
  _ODetailSoldPageState createState() => _ODetailSoldPageState();
}

class _ODetailSoldPageState extends State<ODetailSoldPage> {
  var isLoading = false;
  String? salesName;
  String? markomName;
  getSales() async {
