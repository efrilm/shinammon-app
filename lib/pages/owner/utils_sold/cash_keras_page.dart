...
class OCashKerasPage extends StatefulWidget {
  const OCashKerasPage({Key? key}) : super(key: key);

  @override
  _OCashKerasPageState createState() => _OCashKerasPageState();
}

class _OCashKerasPageState extends State<OCashKerasPage> {
  var isLoading = false;
  var isData = false;
