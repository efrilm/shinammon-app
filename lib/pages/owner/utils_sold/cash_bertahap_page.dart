...
import 'package:shinnamon/pages/owner/utils_sold/detail_sold_page.dart';
...
class OCashBertahapPage extends StatefulWidget {
  const OCashBertahapPage({Key? key}) : super(key: key);

  @override
  _OCashBertahapPageState createState() => _OCashBertahapPageState();
}

class _OCashBertahapPageState extends State<OCashBertahapPage> {
  var isLoading = false;
  var isData = false;
