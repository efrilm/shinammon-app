...
class OKprPage extends StatefulWidget {
  const OKprPage({Key? key}) : super(key: key);

  @override
  _OKprPageState createState() => _OKprPageState();
}

class _OKprPageState extends State<OKprPage> {
  var isLoading = false;
  var isData = false;
