...
class AllWeekPage extends StatefulWidget {
  const AllWeekPage({Key? key}) : super(key: key);

  @override
  _AllWeekPageState createState() => _AllWeekPageState();
}

class _AllWeekPageState extends State<AllWeekPage> {
  var isLoading = false;
  var isData = false;
  ...
  Future<void> getWeekly() async {
    ...
    list.clear();
    final response =
        await http.get(Uri.parse(AppUrl.getWeek + AppCode.project));
